...
///
/// Valid mapped characters in this table are:
/// - NT: `A C G T U R Y S W K M B D H V N X` (and lowercase variants)
/// - AA: `A C D E F G H I K L M N P Q R S T V W Y B X U` (and lowercase variants)
/// - Other: `-` and `.`
///
